...
// Function created for refactorizing the code
...
document.querySelector('.check').addEventListener('click', function () {
  ...
  if (!guess) {
    // document.querySelector('.message').textContent = `⛔️ No number!`;   (REFACTORED TO A FUNCT?ION)
    displayMessage('⛔️ No number');

    // When the guess is different from the secretNumber (REFACTORED CODE)
